...
//     const {tip,quiz} = req;
//
//     res.render('tips/edit', {quiz, tip}); //Por si acaso pasamos el quiz porque es posible que lo necesitemos para editar el tip
// };
//
...
//         res.redirect('/quizzes/${quiz.id}/tips/${tip.id}/edit');
//     })
//     .catch(Sequelize.ValidationError, error => {
//         req.flash('error', 'There are errors in the form:');
//         error.errors.forEach(({message}) => req.flash('error', message));
